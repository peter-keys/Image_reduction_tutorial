...
;             heliocentric coordinates
;
;	      Adapted to a function (P. Keys) to export the values 
;	      so that the code can be used with the ROSA reduction 
;	      pipeline (Adds pointing to FITS header).
;
...
;	      December 2016	P. Keys (QUB)
;
;-

FUNCTION rothel2xy2, hel_start, t_start, t_end, hel_end, xy_start, xy_end
