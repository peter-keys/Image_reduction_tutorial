...
FUNCTION ROSA_destretch,datacube,xsize,ysize,zsize,cadence
...
i=2
ref_image = datacube(*,*,i - step_size) 
ref_image = ref_image / MEDIAN(ref_image) 
des_image = datacube(*,*,i) 
...
FOR i=0,(zsize-1),1 DO BEGIN 
    test_image = doreg(datacube(*,*,i), rdisp_all(*,*,*,i), disp_all_polycor(*,*,*,i)) 
    destretched_images(*,*,i) = test_image 
